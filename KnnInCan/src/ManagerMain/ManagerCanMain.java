...
public class ManagerCanMain {
	...
	public static void main(String[] args) {
		...
		System.out.println(point1.toString() + "is in Zone " + zone.toString());
		zone = managerCan.inWhichZoneIsthePoint(point2);
		System.out.println(point2.toString() + "is in Zone " + zone.toString());
		new Peer();
		Peer peer = managerCan.inWhichPeerIsThePoint(point1);
		peer.displayPeer();
		peer = managerCan.inWhichPeerIsThePoint(point1);
		peer.displayPeer();
	}
}
